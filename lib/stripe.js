...
export const STRIPE_PLANS = {
  ...
  basic: {
    ...
    features: ['1,000 requests/month', 'Priority support', 'API access']
  },
  pro: {
    id: 'pro',
    name: 'Pro',
    ...
    features: ['10,000 requests/month', 'Priority support', 'API access', 'Webhooks']
  },
  enterprise: {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    features: ['100,000 requests/month', 'Dedicated support', 'Custom integrations', 'SLA']
  }
};
