...
export const STRIPE_PLANS = {
  ...
  basic: {
    ...
    priceId: process.env.STRIPE_BASIC_PRICE_ID, // Set this in Vercel env vars
  ...
  pro: {
    id: 'pro',
    name: 'Pro',
    description: 'Perfect for media companies, news organizations, and agencies requiring high-volume analysis. Includes advanced features, webhooks, and dedicated support for professional workflows.',
    price: 4999, // $49.99 in cents
    priceId: process.env.STRIPE_PRO_PRICE_ID, // Set this in Vercel env vars
  ...
  enterprise: {
    id: 'enterprise',
    name: 'Enterprise',
    description: 'Designed for large organizations with enterprise needs. Includes custom integrations, SLA guarantees, and dedicated support for mission-critical media analysis at scale.',
    price: 19999, // $199.99 in cents
    priceId: process.env.STRIPE_ENTERPRISE_PRICE_ID, // Set this in Vercel env vars
