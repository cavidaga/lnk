export function passwordResetHtml(link) {
  return `<!DOCTYPE html>
      ...
      <table class="row-content stack" role="presentation" cellpadding="0" cellspacing="0" style="color:#000; width:500px; margin:0 auto;">
        <tr>
          <td style="padding:24px 0; text-align:center;">
            <img src="https://e014b36d95.imgdist.com/pub/bfra/i4b5wys6/h6e/plc/h5h/logo-light.svg" width="40" alt="LNK.az" style="display:inline-block;border:0;height:auto;"/>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:0 20px 16px 20px;">
            <div style="font-family:'Poppins', Arial, Helvetica, sans-serif; font-size:15px; color:#444a5b; line-height:1.6;">
              ...
              <p style="margin:0 0 12px 0; word-break:break-all;">Əgər düymə işləmir, bu linki brauzerə köçürün:<br/>
